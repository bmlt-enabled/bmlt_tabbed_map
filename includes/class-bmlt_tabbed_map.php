...
class Bmlt_tabbed_map {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Bmlt_tabbed_map_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Bmlt_tabbed_map_Loader. Orchestrates the hooks of the plugin.
	 * - Bmlt_tabbed_map_i18n. Defines internationalization functionality.
	 * - Bmlt_tabbed_map_Admin. Defines all hooks for the admin area.
	 * - Bmlt_tabbed_map_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Bmlt_tabbed_map_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Bmlt_tabbed_map_Loader    Orchestrates the hooks of the plugin.
	 */
